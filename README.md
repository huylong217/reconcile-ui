...
- tham khảo tại https://github.com/Kamar-Meddah/vue-generate-component-typescript
- một số lệnh cơ bản
 + Create new component : vgc footer
 + Create new component single file : vgc -s home
 + Create new directive: vgc -d test
 + Create new Pipe (filter) : vgc -p test
```
